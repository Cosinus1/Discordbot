...
def create_combat_embed(player, monster):
    ...
    embed.set_image(url="attachment://data/mmo/PNG/goblin_vecto.png")  # Use the monster's image URL
    return embed
...
def create_item_embed(item):
    ...
    embed.set_thumbnail(url="attachment://data/mmo/PNG/item.png")  # Use the item's image URL
    return embed
